...
class Patient(db.Model):
    ...
    experiences = db.relationship('PatientExperience', backref='patient', lazy=True)
...
class PatientExperience(db.Model):
    ...
    created_at = db.Column("createdAt",db.Date,nullable=True)
    updated_at = db.Column("updatedAt",db.Date,nullable=True)
    trc_patient_id=db.Column(db.Integer, db.ForeignKey('patient.TRC_patient_id'),nullable=False)
